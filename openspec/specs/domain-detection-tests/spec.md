...
Defines the deterministic unit/integration test suite for all four domain detection workers (health, appointment, grocery, financial) using seed data to assert expected ActionDraft shapes.
