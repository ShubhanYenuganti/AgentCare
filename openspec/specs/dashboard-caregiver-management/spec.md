# Dashboard Caregiver Management

## Purpose

Defines the behavior of the Caregiver Management view in the dashboard, including the scheduling strip, caregiver detail panel with schedule grid, confirm/decline flows, and deep-link preselect from the Action Feed.
