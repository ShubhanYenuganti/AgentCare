...
Defines the typed API client layer for the dashboard, built on RTK Query, including polling hooks and shared TypeScript type definitions for all API response shapes.
