...
Defines stability requirements for mock API response envelopes and test coverage expectations for all mock endpoints used by detection and approval flows.
