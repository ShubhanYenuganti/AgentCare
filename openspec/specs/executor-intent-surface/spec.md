# Executor Intent Surface

## Purpose

Defines the executor's handling of specific intent surfaces: onboarding, scheduling queries, action-bound modification and question handling, general query fallback, and soft-delete behavior for patient data removal.
